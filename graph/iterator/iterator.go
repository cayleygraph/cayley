...
var (
	_ graph.IteratorShape = &Null{}
	_ graph.IteratorShape = &Error{}
)
...
func (it *Error) Iterate() graph.Scanner {
	return it
}

func (it *Error) Lookup() graph.Index {
	return it
}
...
func (it *Error) SubIterators() []graph.IteratorShape {
	return nil
}
