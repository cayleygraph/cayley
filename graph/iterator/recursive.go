...
func NewRecursive(it graph.IteratorShape, morphism Morphism, maxDepth int) *Recursive {
	if maxDepth == 0 {
...
func newRecursiveNext(it graph.Scanner, morphism Morphism, maxDepth int, depthTags []string) *recursiveNext {
