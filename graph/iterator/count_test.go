...
func TestCount(t *testing.T) {
	...
	require.True(t, it.Contains(nil, graph.PreFetched(quad.Int(5))))
	require.False(t, it.Contains(nil, graph.PreFetched(quad.Int(3))))
	...
	require.False(t, it.Next(nil))
	require.False(t, it.Contains(nil, graph.PreFetched(quad.Int(5))))
	require.True(t, it.Contains(nil, graph.PreFetched(quad.Int(2))))
